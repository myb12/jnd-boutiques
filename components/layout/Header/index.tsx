  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-col lg:flex-row gap-3 md:gap-5 items-end lg:items-center xl:justify-between ease-out duration-200 ${
            stickyMenu ? "py-2" : "py-3"
          }`}
        >
          {/* <!-- header top left --> */}
          <div className="xl:w-auto w-full flex justify-between sm:items-center gap-5 sm:gap-10">
                ...
                >
                  <span className="inline-block relative">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="18" viewBox="0 0 21 18" fill="none">
                        <path d="M2.72345 2.8023C0.769267 4.75648 0.769268 7.92483 2.72345 9.87901L9.44713 16.6028C10.0329 17.1886 10.9827 17.1886 11.5685 16.6028L18.2922 9.87912C20.2463 7.92494 20.2463 4.75659 18.2922 2.80241C16.338 0.848229 13.1696 0.84823 11.2155 2.80241L10.5079 3.51001L9.80015 2.8023C7.84597 0.848125 4.67762 0.848125 2.72345 2.8023Z" stroke="#3C50E0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                    </svg>
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                <li className="py-4">
                  ...
                  >
                    Best Selling
                    <span className="bg-red text-white font-semibold text-[10px] inline-flex items-center justify-center rounded-full ml-1  px-2 h-5 uppercase">SALE</span>
                  </Link>
                </li>
              </ul>
            </div>
