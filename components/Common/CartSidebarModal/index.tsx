...
import { removeItemFromCart, selectTotalPrice } from "@/store/features/cart-slice";
...
const CartSidebarModal = () => {
  ...
  return (
    <div>
      <div className={`fixed top-0 left-0 z-9999 overflow-y-auto no-scrollbar w-full h-screen bg-dark/70 ease-linear duration-300 ${
