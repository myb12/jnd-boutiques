...
//         Don't have an account? <Link href="/register" className="text-rose-500 hover:underline">Sign up</Link>
//       </div>
//     </div>
//   );
// }
...
export default function LoginPage() {
  ...
  return (
    <div className="w-full md:min-w-[450px] max-w-md bg-white p-8 rounded-lg shadow-xl border border-gray-100">
      ...
      <div className="mt-6 text-center text-sm text-gray-500">
        Don't have an account? <a href="/register" className="text-rose-500 hover:underline">Sign up</a>
      </div>
    </div>
  );
}
